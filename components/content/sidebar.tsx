...
function ContentSidebar({ isOpen }: ContentSidebarProps) {
	return (
		<CommonSidebar isOpen={isOpen} side="left">
			<SidebarSection title="Content">
				<SidebarItem icon={<FileText className="h-4 w-4" />}>Home</SidebarItem>
				<SidebarItem icon={<FileText className="h-4 w-4" />}>About</SidebarItem>
				<SidebarItem icon={<FileText className="h-4 w-4" />}>
					Contact
				</SidebarItem>
			</SidebarSection>
			<SidebarSection title="Media">
				<SidebarItem icon={<Image className="h-4 w-4" />}>Images</SidebarItem>

		...
		<Popover>
			<PopoverTrigger asChild>
				<Button
					...
					size="tiny"
					className={cn(
						"bg-transparent border-0 px-2 text-muted-foreground hover:text-foreground hover:bg-accent",
						selectedPlatforms.length > 0 && "text-primary",
						className,
					)}
				>
					...
					{selectedPlatforms.length > 0 && (
						<Badge
							variant="secondary"
							className="ml-1.5 h-5 bg-primary/10 text-primary hover:bg-primary/10"
						>
